...
Var.resizable(0,0)
Var.title("game-rock,paper,scissor")
Var.config(bg="purple")
user_take=StringVar()
Label(Var,text="choose any one:rock,paper,scissor",font="arial 15 bold",bg="black")
Entry(Var,font="bold 30",textvariable=user_take,bg="antiquewhite2").place(x=30,y=20)
...
Entry(Var,font="arial 10 bold",textvariable=result,bg="antiquewhite2",width=50).place(x=50,y=250)
